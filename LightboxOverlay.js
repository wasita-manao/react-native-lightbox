...
export default class LightboxOverlay extends Component {
  ...
  render() {
    ...
    const background = (<TouchableOpacity style={[styles.background, { backgroundColor: backgroundColor, zIndex: 9, position: 'absolute' }, lightboxOpacityStyle]} onPress={this.close}></TouchableOpacity>);
    ...
    const content = (
      <Animated.View style={[openStyle, dragStyle]} {...handlers} useNativeDriver={true}>
        {this.props.children}
      </Animated.View>
    );
